...
import com.example.sampleapp.api.response.UserResponse;
...
public class AncestorUserResponseFactory implements AncestorsFactory {
	@Override
	public Ancestor parse(JSONObject response) throws IOException {
		return new ObjectMapper().readValue(response.toString(), UserResponse.class);
	}
